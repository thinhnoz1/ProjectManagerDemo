...
<div class="container">
    <div class="container">
    	...
    	<div class="list-group">
    		...
    		<a href="delete_food_items.php" class="list-group-item active">Xóa món</a>
    ...
    <div class="col-xs-9">
      <div class="form-area" style="padding: 0px 100px 100px 100px;">
        ...
        <br style="clear: both">
          <h3 style="margin-bottom: 25px; text-align: center; font-size: 30px;"> Xóa món ăn </h3>
...
if (mysqli_num_rows($result) > 0)
{
  ...
  <?php } ?>
    ...
    <br>
          ...
          <button type="submit" id="submit" name="delete" value="Delete" class="btn btn-danger pull-right"> XÓA MÓN</button>    
      </div>
